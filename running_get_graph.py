...
#with open('/kaggle/working/sample/data_chung/rxnclass2id.json','r') as f:
...
rgmol_max_cnt=np.max([smi.count('.')+1 for smi in reagent])
...
get_graph_data(rsmi_list_train,y_list_train,filename_train,rmol_max_cnt,pmol_max_cnt,rgmol_max_cnt)
...
get_graph_data(rsmi_list_valid,y_list_valid,filename_valid,rmol_max_cnt,pmol_max_cnt,rgmol_max_cnt)
...
get_graph_data(rsmi_list_test,y_list_test,filename_test,rmol_max_cnt,pmol_max_cnt,rgmol_max_cnt)
